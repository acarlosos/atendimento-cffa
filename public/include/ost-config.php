...
define('SECRET_SALT','x9UgcmlSkEKXUSyKHLKZXZE=LyPDsKIN');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','marcelo@fonoaudiologia.org.br');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','10.116.0.3');
define('DBNAME','CFFaosTicket');
define('DBUSER','CFFaosTicket');
define('DBPASS','xylydtGktv0TvaeaWcxyPbIQV');

# Table prefix
define('TABLE_PREFIX','CFFa_ost_');
